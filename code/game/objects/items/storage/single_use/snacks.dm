...
/obj/item/storage/single_use/bag/californium
	name = "Californium Gummy Worms"
	desc = "A bag of sour gummy worms which has been obviously designed to look dangerous without risking legal trouble with actual hazard identification imagery. Does not contain real Californium-252, although the ads say it disappears just as quickly."
