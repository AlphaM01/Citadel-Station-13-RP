...
/datum/lore/character_background/faction/oriconmil
	name = "Orion Confederacy Military"
	id = "oriconmil"
	...
	allow_species = list(
		SPECIES_ID_HUMAN
		SPECIES_ID_PROMETHEAN
		SPECIES_ID_PROTEAN
		SPECIES_ID_AURIL
		SPECIES_ID_DREMACHIR
		SPECIES_ID_CUSTOM
		)

/datum/lore/character_background/faction/vikaramil
	name = "Vikara Combine Military"
	id = "vikaramil"
	desc = "Spanning most of the central Perseus Arm of the galaxy, the Vikara Combine is the primary galactic ally of the Orion Confederation. \
